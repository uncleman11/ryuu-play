...
export type PossibleActionList = (new (options: SimpleBotOptions) => PossibleActions)[];

export abstract class PossibleActions {
  ...
  public abstract getPossibleActions(state: State, player: Player): Action[];
